...
$(function() {
  [].forEach.call(document.querySelectorAll('img[data-src]'), (img) => {
      var i = new Image();
      i.setAttribute('src', img.getAttribute('data-src'));
      i.onload = () => {
          img.setAttribute('src', i.src);
      }
  });

  [].forEach.call(document.querySelectorAll('div[data-src], nav[data-src]'), (el) => {
      var i = new Image();
      i.setAttribute('src', el.getAttribute('data-src'));
      i.onload = () => {
          el.style.background = 'url("'+ i.src +'") no-repeat center center'
      }
  })
