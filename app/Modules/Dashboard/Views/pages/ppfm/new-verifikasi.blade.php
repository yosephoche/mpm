...
<div id="pendaftaran-mpm-content" class="m-content">
	...
	<div class="mc-breadcrumb" data-uk-sticky="{top:60}">
		<ul class="uk-breadcrumb">
			...
			<li><a href="{{ URL('/ppfm/peserta-baru') }}">Belum Terdaftar</a></li>
	...
	<div class="mc-form">
		<div class="mc-form-wrapper">
			<div class="mc-form-inner">
				<form id="form-pendaftaran-ppfm" action="" method="post" class="uk-form pendaftaran-ppfm">
									...
									<div class="data uk-grid">
										...
										<div class="uk-width-large-1-2 uk-width-medium-1-2 uk-width-small-1-1">
											<div class="data-inner">
												...
												<input id="nama-krt" type="text" name="nama-krt" readonly value="{{ ((App\Models\PesertaMpm::getkrt($peserta[0]->kodepeserta)) ? App\Models\PesertaMpm::getkrt($peserta[0]->kodepeserta)[0]['nama'] : '') }}">
												<!-- <div class="error">Pesan Error</div> -->
											</div>
										</div>
										<div class="uk-width-large-1-2 uk-width-medium-1-2 uk-width-small-1-1">
