...
<div id="pendaftaran-mpm-content" class="m-content">
	...
	<div class="mc-breadcrumb" data-uk-sticky="{top:60}">
		<ul class="uk-breadcrumb">
			...
			<li><a href="javascript:;">Sunting Opsi Indikator</a></li>
		</ul>
	</div>
	<div class="mc-form">
		<div class="mc-form-wrapper">
			<div class="mc-form-inner">
				<form id="form_indikator_opsi_update" action="" method="post" class="uk-form"  novalidate="novalidate">
						...
						<ul class="mcf-list">
							<li class="mcf-item">
								<div class="data uk-grid">
										...
										<div class="data-inner">
											...
											<div class="uk-button uk-form-select uk-active" data-uk-form-select>
												...
												<select id="sub-opsi" name="sub-opsi">
													...
													<option value="1" {{ ($opsiindi[0]->sub_opsi == '1') ? 'selected' : '' }}>Ya</option>
													<option value="2" {{ ($opsiindi[0]->sub_opsi == '2') ? 'selected' : '' }}>Tidak</option>
												</select>
											</div>
											...
											<div class="uk-button uk-form-select uk-active" data-uk-form-select>
			                                    ...
			                                    <select id="nama-variabel" name="nama-variabel">
                                                    ...
                                                    @foreach($indi as $listindi)
                                                        <option value="{{ $listindi->kode_variabel }}" {{ ($listindi->kode_variabel == $opsiindi[0]->kode_variabel) ? 'selected' : '' }}>{{ $listindi->nama }}</option>
                                                    @endforeach
			                                    </select>
											</div>
									...
									<!-- <div class="uk-width-large-1-2 uk-width-medium-1-2 uk-width-small-1-1 {{ ($opsiindi[0]->sub_opsi == '1') ? '' : 'uk-hidden' }}">
										<div class="data-inner">
											<label for="nama-sub">Nama Sub Variabel</label>
											<input id="nama-sub" type="text" name="nama-sub" value="{{ $opsiindi[0]->nama_sub }}">
										...
										<div class="data-inner">
											...
											<div class="uk-button uk-form-select uk-active" data-uk-form-select>
												...
												<select id="opsi-indi" name="opsi-indi">
													...
													@foreach($opsi as $opsiindivar)
									                                                        <option value="{{ $opsiindivar->no_opsi }}" {{ ($opsiindivar->no_opsi == $opsiindi[0]->opsi_indi) ? 'selected' : '' }}>{{ $opsiindivar->no_opsi.'. '.$opsiindivar->desc_opsi }}</option>
									                                                    @endforeach
												</select>
											</div>
											<div class="error" id="nama-variabel_err"></div>
									...
									<div class="uk-width-large-1-2 uk-width-medium-1-2 uk-width-small-1-1">
										<div class="data-inner">
											...
											<input id="no-opsi" type="text" name="no-opsi" value="{{ $opsiindi[0]->no_opsi }}">
                                    ...
                                    <div class="uk-width-large-1-2 uk-width-medium-1-2 uk-width-small-1-1">
										<div class="data-inner">
											...
											<input id="desc-opsi" type="text" name="desc-opsi" value="{{ $opsiindi[0]->desc_opsi }}">
										...
										<div class="data-inner">
											...
											<div class="uk-button uk-form-select uk-active" data-uk-form-select>
												<span class="">Rincian Jawaban</span>
													...
													<option value="1" {{ ($opsiindi[0]->rincian == '1') ? 'selected' : '' }}>Ya</option>
												                                        <option value="2" {{ ($opsiindi[0]->rincian == '2') ? 'selected' : '' }}>Tidak</option>
												                                    </select>
											</div>
								...
								<div class="submit">
									<div class="uk-clearfix">
										<div class="uk-float-right">
											<button name="submit" id="submit-save" data-id="{{ $opsiindi[0]->_id }}" type="submit">Simpan</button>
										</div>
									</div>
								</div>
							</li>
