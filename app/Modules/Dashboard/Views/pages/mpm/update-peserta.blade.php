...
<div id="pendaftaran-mpm-content" class="m-content">
	...
	<div class="mc-breadcrumb" data-uk-sticky="{top:60}">
        <ul class="uk-breadcrumb">
            ...
            <li><a href="javascript:;">Sunting Peserta MPM</a></li>
        </ul>
    </div>
	<div class="mc-form">
		<div class="mc-form-wrapper">
			<div class="mc-form-inner">
				<form id="form-update-mpm" action="" method="post" class="uk-form"  novalidate="novalidate">
					<input type="hidden" name="_token" id="_token" value="{{ csrf_token() }}">
					<div class="mcf-content">
						<div class="mcf-title">
							<h3>Formulir Sunting Rumah Tangga Miskin & Kurang Mampu</h3>
						</div>
						<ul class="mcf-list">
							<li class="mcf-item">
								<div class="title">
								...
								<div class="data uk-grid">
									<div class="uk-width-large-1-2 uk-width-medium-1-2 uk-width-small-1-1">
										<div class="data-inner">
											...
											<input id="nomorKk" type="text" name="nomorKk" value="{{ $peserta[0]->nokk }}" maxlength="16">
									...
									<div class="uk-width-large-1-2 uk-width-medium-1-2 uk-width-small-1-1">
										<div class="data-inner">
											...
											<input id="nik" type="text" value="{{ $peserta[0]->pendaftar[0]['nik'] }}" name="nik" maxlength="16">
										...
										<div class="data-inner">
											...
											<div class="uk-button uk-form-select uk-active" data-uk-form-select>
			                                    ...
			                                    <select id="jenisKelamin" name="jenisKelamin">
			                                        <option value="1" {{ ($peserta[0]->pendaftar[0]['jenkel'] == '1') ? 'selected' : '' }}>Laki-Laki</option>
			                                        <option value="2" {{ ($peserta[0]->pendaftar[0]['jenkel'] == '2') ? 'selected' : '' }}>Perempuan</option>
			                                    </select>
											</div>
										...
										<div class="data-inner">
											...
											<div class="uk-button uk-form-select uk-active" data-uk-form-select>
												...
												<select id="{{ $hubkk->kode_variabel }}" name="{{ $hubkk->kode }}">
													...
													<option value="{{ $listopsi->no_opsi }}" {{ ( $listopsi->no_opsi == $peserta[0]->pendaftar[0]['b4_k5'] ) ? 'selected' : '' }}>{{ $listopsi->no_opsi.'. '.$listopsi->desc_opsi }}</option>
													@endforeach
												</select>
											</div>
										...
										<div class="data-inner">
											...
											<div class="uk-button uk-form-select uk-active" data-uk-form-select>
												...
												<select id="{{ $hubrt->kode_variabel }}" name="{{ $hubrt->kode }}">
													...
													<option value="{{ $listopsi->no_opsi }}" {{ ( $listopsi->no_opsi == $peserta[0]->pendaftar[0]['b4_k3'] ) ? 'selected' : '' }}>{{ $listopsi->no_opsi.'. '.$listopsi->desc_opsi }}</option>
													@endforeach
												</select>
											</div>
								...
								<div class="data uk-grid">
									<div class="uk-width-large-1-2 uk-width-medium-1-2 uk-width-small-1-1">
										<div class="data-inner">
											...
											<input id="nikKepRt" type="text" name="nikKepRt" value="{{ $peserta[0]->individu[0]['nik'] }}" maxlength="16">
									...
									<div class="uk-width-large-1-2 uk-width-medium-1-2 uk-width-small-1-1">
										<div class="data-inner">
											...
											<input id="namaKepRt" type="text" value="{{ $peserta[0]->individu[0]['nama'] }}" name="namaKepRt">
										...
										<div class="data-inner">
											...
											<div class="uk-button uk-form-select uk-active" data-uk-form-select>
			                                    ...
			                                    <select id="jenisKelKepRt" name="jenisKelKepRt">
			                                        <option value="1" {{ ($peserta[0]->individu[0]['b4_k6'] == '1') ? 'selected' : '' }}>Laki-Laki</option>
			                                        <option value="2" {{ ($peserta[0]->individu[0]['b4_k6'] == '2') ? 'selected' : '' }}>Perempuan</option>
			                                    </select>
											</div>
									...
									<div class="uk-width-large-1-2 uk-width-medium-1-2 uk-width-small-1-1">
										<div class="data-inner">
											...
											<input id="umur" type="text" name="umur" value="{{ $peserta[0]->individu[0]['b4_k7'] }}">
										...
										<div class="data-inner">
											...
											<div class="uk-button uk-form-select uk-active" data-uk-form-select>
			                                    ...
			                                    <select id="pekerjaanKepRt" name="pekerjaanKepRt">
			                                        ...
			                                        <option value="1" {{ ($peserta[0]->individu[0]['statusbekerja'] == '1') ? 'selected' : '' }}>1. Bekerja</option>
			                                        <option value="2" {{ ($peserta[0]->individu[0]['statusbekerja'] == '2') ? 'selected' : '' }}>2. Tidak Bekerja</option>
			                                    </select>
											</div>
									...
									<div class="uk-width-large-1-2 uk-width-medium-1-2 uk-width-small-1-1">
										<div class="data-inner">
											...
											<input id="jumAngKel" type="text" name="jumAngKel" value="{{ $peserta[0]->b1_k9 }}">
									...
									<div class="uk-width-large-1-2 uk-width-medium-1-2 uk-width-small-1-1">
										<div class="data-inner">
											...
											<div class="uk-button uk-form-select uk-active" data-uk-form-select>
			                                    ...
			                                    <i class="uk-icon-angle-down uk-icon-medium"></i>
			                                    <select id="kecamatan-upd" name="kecamatan">
													<option value="">Pilih Kecamatan</option>
													@foreach($kecamatan as $listkec)
			                                        <option value="{{ $listkec->id_kecamatan }}" {{ ($peserta[0]->kec == $listkec->id_kecamatan) ? 'selected' : '' }} >{{ $listkec->kecamatan }}</option>
													@endforeach
			                                    </select>
											</div>
									...
									<div class="uk-width-large-1-2 uk-width-medium-1-2 uk-width-small-1-1">
										<div class="data-inner">
											...
											<div class="uk-button uk-form-select uk-active" data-uk-form-select>
			                                    ...
			                                    <i class="uk-icon-angle-down uk-icon-medium"></i>
			                                    <select id="kelurahan-upd" name="kelurahan">
			                                        <option value="">Pilih Kelurahan</option>
                                                    @foreach($kelurahan as $listkel)
			                                        <option value="{{ $listkel->id_kelurahan }}" {{ ($peserta[0]->des == $listkel->id_kelurahan) ? 'selected' : '' }} >{{ $listkel->kelurahan }}</option>
													@endforeach
			                                    </select>
											</div>
							...
							<li class="mcf-item">
								...
								<div class="data uk-grid">
									...
									@php($kodert = $listindirt->kode_variabel)
									<div class="uk-width-large-1-2 uk-width-medium-1-2 uk-width-small-1-1">
										<div class="data-inner uk-text-left">
											...
											<div class="checkbox">
												@foreach(App\Models\OpsiIndikator::getopsi($listindirt->kode_variabel) as $listopsirt)
													<div><input id="{{ $listopsirt->kode_variabel.'_'.$listopsirt->no_opsi }}" data-status="rt" {{ ( $listopsirt->no_opsi == $peserta[0]->datart[0][$kodert] ) ? 'checked' : '' }} value="{{ $listopsirt->no_opsi }}" type="radio" name="{{ $listindirt->kode_variabel }}"><label for="{{ $listopsirt->kode_variabel.'_'.$listopsirt->no_opsi }}">{{ $listopsirt->no_opsi.'. '.$listopsirt->desc_opsi }}</label></div>
												@endforeach
											</div>
									...
									@php($kodeasset = $listindiasset->kode_variabel)
									<div class="uk-width-large-1-2 uk-width-medium-1-2 uk-width-small-1-1">
										<div class="data-inner uk-text-left">
											<label for="">{{ $listindiasset->nama }}</label>
											<div class="checkbox">
												@foreach(App\Models\OpsiIndikator::getopsi($listindiasset->kode_variabel) as $listopsiasset)
													<div><input id="{{ $listopsiasset->kode_variabel.'_'.$listopsiasset->no_opsi }}" data-status="asset" {{ ( $listopsiasset->no_opsi == $peserta[0]->asset[0][$kodeasset] ) ? 'checked' : '' }} value="{{ $listopsiasset->no_opsi }}" type="radio" name="{{ $listindiasset->kode_variabel }}"><label for="{{ $listopsiasset->kode_variabel.'_'.$listopsiasset->no_opsi }}">{{ $listopsiasset->no_opsi.'. '.$listopsiasset->desc_opsi }}</label></div>
												@endforeach
											</div>
										...
										<div class="data-inner uk-text-left">
											...
											<div class="checkbox">
												@foreach(App\Models\OpsiIndikator::getopsi('b4_k18') as $listopsipd)
													<div><input id="{{ 'pendidikanart_'.$listopsipd->no_opsi }}" value="{{ $listopsipd->no_opsi }}" {{ ( $listopsipd->no_opsi == $peserta[0]->pendidikanart ) ? 'checked' : '' }} type="radio" name="pendidikanart"><label for="{{ 'pendidikanart_'.$listopsipd->no_opsi }}">{{ $listopsipd->no_opsi.'. '.$listopsipd->desc_opsi }}</label></div>
												@endforeach
											</div>
								...
								<div class="submit">
									<div class="uk-clearfix">
										<div class="uk-float-right">
											<button name="submit" id="update-save" data-id="{{ $peserta[0]->_id }}" type="submit">Simpan</button>
										</div>
									</div>
								</div>
							</li>
